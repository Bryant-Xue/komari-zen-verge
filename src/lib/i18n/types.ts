...
export type Messages = {
  ...
  mapLegendOnline: string;
  mapLegendPartial: string;
  mapLegendOffline: string;
  mapUnmappedRegions: string;
  mapUnmappedCount: string;
  mapActiveCountries: string;
  mapServers: string;
  mapOnlineCount: string;
  mapOfflineCount: string;
  mapCountrySummary: string;
  mapStatusOnline: string;
  mapStatusPartial: string;
  mapStatusOffline: string;
  mapRegionUnknown: string;
  mapNodes: string;
  mapFocusBack: string;
  mapUptime: string;
  mapRegionNodes: string;
};
